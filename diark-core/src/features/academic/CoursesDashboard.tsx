...
import { SmartTaskExtractorModal } from './components/SmartTaskExtractorModal';
...
export const CoursesDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-800 pb-5">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-indigo-600/30 bg-indigo-600/10 hover:bg-indigo-600/20 text-xs font-medium text-indigo-300 transition-colors cursor-pointer"
            title="Bóc tách thông báo bài giảng văn xuôi thành nhiệm vụ bằng Gemini AI"
          >
            <Sparkles className="h-3.5 w-3.5 text-indigo-400" />
            <span>Bóc tách thông báo</span>
          </button>
      ...
      {/* Smart Task Extractor Modal */}
      <SmartTaskExtractorModal
        ...
        onTasksSaved={() => {
          if (selectedCourseId) {
            refreshCourseDetails(selectedCourseId);
          }
          loadData(false);
        }}
      />
