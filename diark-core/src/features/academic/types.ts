...
// ============================================================
//  Exam Radar & Daily Briefing Types (v0.7.0)
// ============================================================
...
export interface PortalExamItemDto {
  id?: number | null;
  subject_code: string;
  subject_name: string;
  section_class_id?: string | null;
  section_class_code?: string | null;
  format?: string | null;
...
export interface PortalExamSchedulePayload {
  items: PortalExamItemDto[];
}
...
export interface DailyBriefingDto {
  ...
  upcoming_exam: AcademicExamRecord | null;
  generated_at: number;
}
